...
const OurStory = () => {
	return (
		<div className="md:mt-56 mt-36 xl:w-[90%] 3xl:w-[80%] w-full flex flex-col items-center">
			<div className="w-full bg-white rounded-xl md:p-12 p-4 flex flex-col items-center">
				<h1 className="text-brown xl:text-[3rem] text-[2rem] font-[400] mb-8">Our Story</h1>
				<div className="mb-10">
					<img
						src={showcase}
						alt="showcase"
