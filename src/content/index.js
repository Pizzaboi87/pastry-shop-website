...
const comments = [
  {
    relatedID: "waffle-post",
    title: "Fusce odio metus",
    author: "John Smith",
    comment:
      "Fusce odio metus, viverra non ante eu, vulputate viverra massa. Sed sollicitudin, enim sed pellentesque malesuada, quam augue facilisis magna, a pharetra sem elit vel ligula.",
    date: 16.8915e11,
  },
  {
    relatedID: "waffle-post",
    ...
    author: "Nick Fury",
    comment:
      "Curabitur hendrerit dolor non odio luctus, ultricies faucibus sem sodales. Morbi rhoncus aliquet eleifend. Aliquam ut sodales ex.",
    date: 16.8948e11,
  },
  {
    relatedID: "gift-post",
    title: "viverra non ante eu",
    author: "Margareta Grass",
    comment:
      "Vivamus blandit euismod sem ac porttitor. Duis venenatis metus vitae dui malesuada, ornare placerat justo volutpat.",
    date: 16.8988e11,
  },
  {
    relatedID: "macaron-post",
    title: "Quam augue",
    author: "Irene Blue",
    comment:
      "Ut venenatis purus a porttitor porta. Duis nec posuere ligula, sit amet tincidunt massa. Pellentesque volutpat justo turpis, eget accumsan tellus pulvinar vitae.",
    date: 16.8988e11,
  },
  {
    relatedID: "macaron-post",
    title: "Elit vel ligula",
    author: "Olga Kantz",
    comment:
      "Etiam eros dolor, auctor vel ultrices vel, ultricies eget nisl. Maecenas vitae risus sit amet ex feugiat congue. Fusce dictum, quam quis ultrices tristique, mauris libero rutrum odio, sed mattis massa nisi ut dolor. Donec tempus ultrices nulla, ac egestas enim varius ut. In hac habitasse platea dictumst.",
    date: 16.8948e11,
  },
];
export { dummyPosts, categories, comments };
